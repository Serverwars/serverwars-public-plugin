...
object CommandLobbySetGameType {
    ...
    fun run(ctx: CommandContext<CommandSourceStack>, gameType: GameServerType): Int {
        try {
            ...
            ctx.source.sender.sendTranslatedMessage("command.lobby.set.game_type.success", gameType.value)
            lobby.sendMessage("command.lobby.set.game_type.success.notify_lobby", gameType.value)
